...
import { Trash2, Plus, MousePointer2, Move, Link, Eraser, Info, Route, Download, Upload, RotateCcw } from "lucide-react";
    ...
    <div className="w-80 border-l bg-card h-full flex flex-col shrink-0">
      ...
      <div className="p-4 border-b">
        ...
        >
          ...
          <ToggleGroupItem value="delete" className="flex-1 text-xs text-destructive data-[state=on]:text-destructive">
              ...
              <div className="space-y-4">
                <div className="grid gap-1.5">
                  ...
                  <Input 
                    ...
                    onChange={(e) => updateStation(selectedStation.id, { name: e.target.value })}
                  />
                </div>
                ...
                <div className="grid gap-1.5">
                  ...
                  <Input 
                    ...
                    onChange={(e) => updateStation(selectedStation.id, { nameEn: e.target.value })}
                  />
                </div>
                ...
                <div className="grid gap-1.5">
                  ...
                  <Input 
                    ...
                    onChange={(e) => updateStation(selectedStation.id, { numbering: e.target.value })}
                  />
                </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                    <Label htmlFor="legend-toggle" className="text-[10px] font-bold uppercase text-muted-foreground/60">Legend</Label>
                    <Switch id="legend-toggle" checked={showLegend} onCheckedChange={toggleLegend} className="scale-75 origin-right" />
                </div>
                <Button variant="outline" size="sm" onClick={handleAddLine} className="h-8 shadow-sm">
            ...
            {linesArray.length === 0 ? (
                ...
                <div className="space-y-2">
                    {linesArray.map(line => {
                        ...
                        const lineEdges = Object.values(edges).filter(e => e.lineId === line.id);
                        const stationCount = new Set(lineEdges.flatMap(e => [e.station1Id, e.station2Id])).size;
                        ...
                        return (
                            <div 
                                ...
                                className={cn(
                                    ...
                                    isSelected ? "ring-2 ring-primary border-transparent bg-primary/5" : "bg-background hover:bg-muted/30"
                                )}
                                ...
                                {isSelected && (
                                    <div className="mt-3 pt-3 border-t space-y-3 animate-in fade-in slide-in-from-top-1 duration-200">
                                        <div className="text-[10px] text-muted-foreground flex justify-between px-1">
                                            ...
                                            <span>{stationCount} Stations • {lineEdges.length} Edges</span>
                                        </div>
      ...
      <div className="p-4 border-t bg-muted/5 space-y-3">
        <Label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider px-1">Project Management</Label>
        <div className="grid grid-cols-2 gap-2">
            <Button variant="outline" size="sm" onClick={handleExport} className="h-8 text-[11px]">
            ...
            <AlertDialog>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>マップをインポートしますか？</AlertDialogTitle>
                        <AlertDialogDescription>
            ...
            <AlertDialog>
                <AlertDialogTrigger asChild>
                    <Button variant="outline" size="sm" className="h-8 text-[11px] text-destructive hover:text-destructive col-span-2">
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>全てのデータを消去しますか？</AlertDialogTitle>
                        <AlertDialogDescription>
                    ...
                    <AlertDialogFooter>
                        <AlertDialogCancel>キャンセル</AlertDialogCancel>
                        <AlertDialogAction onClick={resetMap} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
                            全て消去
                        </AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
